const qnaList = [
  {
    q: '1. 하루 일과를 끝 마친 후, 게임을 켰다. 처음 할 일은...',
    a: [
      { answer: '다같이 하하호호 게임해야지! 디스코드 켜서 접속 중인 친구를 찾는다.', type: [1, 2, 4, 9] },
      { answer: '인생은 원래 혼자야! 게임 접속해 혼자 광활한 맵을 돌아다닌다.', type: [0, 3, 6, 5, 8] },
    ]
  },
  {
    q: '2. 새로운 챔피언이 나온다는 공지를 봤다. 이 때 나는...',
    a: [
      { answer: '설렌다! 이걸로 어떤 슈퍼플레이 할지 상상하며 출시일을 기다린다.', type: [0, 3, 2, 8] },
      { answer: '새로운 챔피언이 나와도 달라질 건 없다. 난 나만의 길을 간다.', type: [1, 6, 5] },
    ]
  },
  {
    q: '3. 열심히 게임을 하다가 꼭 해야 할 일이 생각났다. 이 때 나는...',
    a: [
      { answer: '일단 지금은 이 판이 더 중요하다. 쿨하게 미룬다.', type: [1, 3, 2, 8] },
      { answer: '게임 끄고 먼저 할 일을 해치우고 편한 마음으로 다시 접속한다.', type: [7, 9] },
    ]
  },
  {
    q: '4. 드디어 새로운 시즌이 찾아왔다. 이때 나는...',
    a: [
      { answer: '메타 분석글을 읽고 준비를 끝낸 후 실전에 뛰어든다.', type: [1, 2, 4 ] },
      { answer: '메타는 원래 맞으면서 배우는 것이다. 일단 실전에 돌입한다.', type: [7,  8, 9] },
    ]
  },
  {
    q: '5. 게임 실력을 키우기 위해 나는...',
    a: [
      { answer: '이론부터 철저해야 한다. 유튜브와 분석글을 모두 섭렵한다.', type: [1, 7, 4, 9 ] },
      { answer: '경험이 곧 실력이다. 플레이를 많이 해 본다.', type: [0, 3, 6]},
    ]
  },
  {
    q: '6. 게임을 할 때 나의 마음가짐은...',
    a: [
      { answer: '게임은 이기기 위해 하는 것이다.', type: [4, 9 ] },
      { answer: '게임은 남들 킹받게 만들려고 하는 것이다.', type: [0, 3, 6] },
    ]
  },
  {
    q: '7. 열심히 게임을 하는데 아무래도 각이 안 보인다. 이 때 나는...',
    a: [
      { answer: '대충 끝내고 다음 판을 기약한다.', type: [1, 7 ] },
      { answer: '나에겐 포기란 없다. 이기겠다는 마음가짐으로 임한다.', type: [2, 4, 9 ] },
    ]
  },
  {
    q: '8. 누가 나한테 시비를 걸었다. 이 때 나는...',
    a: [
      { answer: '열반에 오른 심정으로 저 중생을 갸륵히 여겨 무시한다.', type: [0, 4, 9 ] },
      { answer: '눈에는 눈, 이에는 이다. 똑같이 시비를 턴다.', type: [3, 2, 6, 5,  8 ] },
    ]
  },
  {
    q: '9. 아무리 생각해도 내가 이 판 캐리했다. 이때 나는...',
    a: [
      { answer: '모두들 나를 봐줘! 이 세상 사람들이 다 알도록 자랑한다.', type: [7, 0, 5, 9 ] },
      { answer: '그럴 리 없다는 걸 안다. 빨리 겸손을 찾고 마음 속에 묻어둔다.', type: [1, 3, 6] },
    ]
  },
  {
    q: '10. 게임할 때 나에게 중요한 건... ',
    a: [
      { answer: '무얼 하든지 남는 건 결과다. 좋은 결과를 내야 한다.', type: [4, 9] },
      { answer: '결과보다는 노력이 중요하다. 포기하지 않는 내 모습 참 좋다.', type: [0, 2, 6, 5 ] },
    ]
  },
  {
    q: '11. 이거 한타 각인가? 헷갈리는 상황에서 나는...',
    a: [
      { answer: '틀릴 수도 있지만, 아무튼 한타다. 일단 간다.', type: [1, 4, 9, ] },
      { answer: '위험한 선택을 할 수는 없다. 상황을 한번 더 살핀다.', type: [7, 0, 3, 6] },
    ]
  },
  {
    q: '12. 내가 생각한대로 게임이 흘러가지 않는다. 여기서 나는...',
    a: [
      { answer: '빠르게 다른 방법을 모색해 대응한다.', type: [3, 6, 4, 9 ] },
      { answer: '우왕좌왕하다 스트레스를 받는다.', type: [0, 2, 5, 8] },
    ]
  },
  {
    q: '13. 게임을 하다가 실수 했다. 이럴 때 나는...',
    a: [
      { answer: '아무튼 내 책임 아니다. 꼬우면 니가 잘하시든가~', type: [3, 6, 4, 9 ] },
      { answer: '이래서 솔플 아닌 게임은 싫다. 자책한다.', type: [0, 2, 5, 8] },
    ]
  },
]
