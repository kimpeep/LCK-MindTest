const qnaList = [
  {
    q: '1. 하루 일과를 끝 마친 후, 게임을 켰다. <br> 처음 할 일은...',
    a: [
      { answer: '다같이 하하호호 게임해야지! <br> 디스코드 켜서 접속 중인 친구를 찾는다.', type: [0,2,3,4,5] },
      { answer: '인생은 원래 혼자야! <br> <br>게임 접속해 혼자 광활한 맵을 돌아다닌다.', type: [1,6,7,8,9] },
    ]
  },
  {
    q: '2. 새로운 챔피언이 나온다는 공지를 봤다. <br> 이 때 나는...',
    a: [
  ...
  {
    q: '3. 열심히 게임을 하다가 <br> 꼭 해야 할 일이 생각났다. 이 때 나는...',
    a: [
